  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-stone-900 tracking-tight">Meus Eventos</h1>
          <p className="text-stone-500 mt-1">Acompanhe e gerencie seus eventos contratados.</p>
        </div>
        <Link to="/cliente/contratar" className="bg-amber-600 hover:bg-amber-700 text-white px-5 py-2.5 rounded-lg font-medium transition-colors inline-block text-center">
          Novo Evento
        </Link>
      </div>
      ...
      <div className="grid gap-4">
        {events.map((event) => (
          <motion.div
            ...
            className="bg-white border border-stone-200 rounded-xl p-5 hover:shadow-md transition-all flex flex-col md:flex-row md:items-center gap-6"
          >
