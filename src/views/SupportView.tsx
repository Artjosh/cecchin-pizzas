  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      <div className="text-center space-y-2 mb-10">
        <h1 className="text-3xl font-bold text-on-surface tracking-tight">Como podemos ajudar?</h1>
        <p className="text-on-surface-variant max-w-lg mx-auto">Nossa equipe de suporte está pronta para tirar suas dúvidas e garantir que seu evento seja perfeito.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm text-center hover:border-amber-300 transition-colors cursor-pointer group">
          ...
          <p className="text-sm text-on-surface-variant mb-4">Atendimento rápido das 09h às 22h</p>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm text-center hover:border-amber-300 transition-colors cursor-pointer group">
          ...
          <h3 className="font-bold text-on-surface mb-1">Ligação</h3>
          <p className="text-sm text-on-surface-variant mb-4">Para urgências durante eventos</p>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm text-center hover:border-amber-300 transition-colors cursor-pointer group">
          ...
          <h3 className="font-bold text-on-surface mb-1">E-mail</h3>
          <p className="text-sm text-on-surface-variant mb-4">Para orçamentos corporativos</p>
          <span className="text-blue-600 font-medium text-sm">contato@cecchin.com.br</span>
        </div>
      </div>

      <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/50 shadow-sm overflow-hidden mt-8">
        <div className="p-6 border-b border-outline-variant/30 bg-surface-container-low flex items-center gap-3">
          <HelpCircle className="w-5 h-5 text-on-surface-variant/70" />
          <h2 className="font-bold text-on-surface">Perguntas Frequentes (FAQ)</h2>
        </div>
