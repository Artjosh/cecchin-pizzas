...
export function EnviarMensagemWhatsapp({ telefones }: { telefones: string[] }) {
  ...
  return (
    <form onSubmit={enviar} className="rounded-xl bg-surface-container-low p-space-md flex flex-col gap-space-sm">
      <div><h2 className="font-headline-sm text-headline-sm text-on-surface">Responder pela Central</h2><p className="mt-1 font-body-sm text-on-surface-variant">Texto livre só é aceito até 24 horas depois da última mensagem recebida. Depois disso, use um template aprovado.</p></div>
