...
export type ReservaParaCobrar = { id: string; data_evento: string; horario: string; endereco: string; status: string; valor_estimado: string | number; sinal_estimado: string | number; adultos: number; criancas: number };
