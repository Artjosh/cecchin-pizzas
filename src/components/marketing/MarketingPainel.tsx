...
type Dados = { agenda: Agenda[]; maisAgenda: boolean; solicitacoes: Solicitacao[]; perfis: Perfil[]; alertas: { agenda_id: string; criado_em: string; lido_em: string | null }[]; concorrentes: Concorrente[] };
