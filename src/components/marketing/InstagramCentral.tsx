...
export function InstagramCentral({ gestor }: Props) {
  ...
  return <div className="mx-auto flex h-full min-h-0 max-w-3xl flex-col overflow-hidden rounded-2xl bg-surface-container-lowest shadow-sm ring-1 ring-outline-variant/30">
    ...
    {sessaoInstagram && aba === "feed" && <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-3">
      <div ref={faixaStoriesRef} className="mb-3 flex gap-3 overflow-x-auto overscroll-x-contain pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
