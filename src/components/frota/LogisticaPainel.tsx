...
export function LogisticaPainel({ diaInicial, compacto = false, aoAtualizarMapa }: { diaInicial?: string; compacto?: boolean; aoAtualizarMapa?: (resumo: ResumoMapaLogistico | null) => void } = {}) {
