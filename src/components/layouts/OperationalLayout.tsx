  ...
  return (
    <ContextoTitulo.Provider value={setTitulo}><div onClickCapture={registrarOrigem} className="min-h-screen bg-surface font-body-md text-body-md text-on-surface antialiased flex">
            ...
            {podeVer(['admin']) && (
              <>
                ...
                >
                  ...
                  <span className="font-label-lg text-label-lg">Frota</span>
                </Link>
              </>
            )}
          </nav>
      ...
      <div className="w-full lg:pl-72 flex flex-col min-w-0">
        ...
        */}
        <main className={pathname === "/operacional/whatsapp" || pathname === "/operacional/mapa" || pathname === "/operacional/marketing" ? "h-[calc(100dvh-4rem)] min-h-0 min-w-0 overflow-hidden bg-surface p-3 md:p-4" : "flex-1 bg-surface px-space-md py-3 md:px-space-lg pb-24 min-w-0"}>
