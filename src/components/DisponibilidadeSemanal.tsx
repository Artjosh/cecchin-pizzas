...
import { DisponibilidadeCarro } from "./DisponibilidadeCarro";
...
export function DisponibilidadeSemanal() {
 ...
 <p className="text-sm text-on-surface-variant">Declare os sete dias, inclusive os dias indisponíveis. Você pode adiantar as próximas semanas. Horários informados pelo WhatsApp como “apenas um turno” aparecem aqui com início e fim.</p>
 ...
 </section><DisponibilidadeCarro semana={semana}/></>;
}
