...
export default function RetornoPagamentoConversa() {
  return <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center gap-4 p-6 text-on-surface">
    ...
    <p>A reserva será confirmada depois que verificarmos o pagamento com a InfinitePay. Esta tela, por si só, não confirma o pagamento. Se você já pagou, aguarde a conferência antes de pagar novamente.</p>
